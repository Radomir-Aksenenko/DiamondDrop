          ...
          <div className="flex flex-col items-start gap-3 self-stretch p-5 md:p-6 rounded-xl bg-[#F9F8FC]/[0.05] w-full md:w-[679px] h-auto md:h-[288px]">
            <div className='flex flex-col md:flex-row h-auto md:h-[256px] items-center gap-5 md:gap-4 self-stretch'>
              ...
              <div className='flex py-2 flex-col justify-between items-start flex-1 self-stretch w-full md:w-auto'>
                ...
                <div className='flex items-center gap-3 md:gap-2 mt-4 md:mt-0'>
                  {[1, 2, 3, 4].map((number) => (
                ...
                {/* Кнопки действий */}
                <div className='flex items-center gap-3 md:gap-2 w-full md:w-auto mt-4 md:mt-0'>
                  <motion.button
                    onClick={() => handleOpenCase(false)}
                    disabled={isSpinning}
                    className={`flex px-3 py-2 md:px-4 md:py-3 justify-center items-center gap-1.5 md:gap-2 rounded-lg md:rounded-xl transition-colors duration-200 flex-1 md:flex-initial ${isSpinning
