...
function SPWContent({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // В dev режиме тоже используем реальную инициализацию SPW для получения настоящих данных
    console.log('🔧 Dev режим: используем реальную инициализацию SPW для получения данных пользователя');
